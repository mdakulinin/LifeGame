...
def drawCross(screen, x, y):
    line(screen, black, [x+8, y+8], [x+92, y+92], 7)
    line(screen, black, [x+8, y+92], [x+92, y+8], 7)
...
def drawSelect(screen):
    ...
    while not finished:
        ...
        drawRect(screen, w-550, h+60)
        drawRect(screen, w-300, h+60)
        drawRect(screen, w-50, h+60)
        drawRect(screen, w+200, h+60)
        drawRect(screen, w+450, h+60)
        ...
        if w-550 <= mouse[0] <= w-450 and h+60 <= mouse[1] <= h+160:
            drawCross(screen, w-550, h+60)
        if w-300 <= mouse[0] <= w-200 and h+60 <= mouse[1] <= h+160:
            drawCross(screen, w-300, h+60)
        if w-50 <= mouse[0] <= w+50 and h+60 <= mouse[1] <= h+160:
            drawCross(screen, w-50, h+60)
        if w+200 <= mouse[0] <= w+300 and h+60 <= mouse[1] <= h+160:
            drawCross(screen, w+200, h+60)
        if w+450 <= mouse[0] <= w+550 and h+60 <= mouse[1] <= h+160:
            drawCross(screen, w+450, h+60)
        ...
        for ev in pygame.event.get():                    
            ...
            if ev.type == pygame.MOUSEBUTTONDOWN: 
                if width/2-182 <= mouse[0] <= width/2+182 and height/2-70 <= mouse[1] <= height/2+15:  
                    ...
                    os.system("python game.py -g " + str(genome_size))
                    finished = True
